...
$sql2 = mysql_query("UPDATE user set blockRange = blockRange - 1 WHERE user_name='$username'");
...
<body>
    ...
    <section id="sidebar">
      ...
      <section id="intro">
        ...
        <header>
          ...
          <p>You have finished your study session. You currently have <?php echo ($blockRange-1);?> study sessions remaining.</p>
        </br>
      </header>
      ...
      <div id="break">        
        <a href="diceroll.php">
          <p class="submit"><input type="submit" name="commit" value="Take Your Break";> </p>
       </a> 
      </div>
      <div id="continue">      
	<?php if(($blockRange-1) <= 1): ?> 
	  <p class="submit"><input type="submit" name="commit" value="Rollover the Break Time"; onclick="cantRollover()"> </p>
	<?php else: ?>
        <a href="rollover.php">
          <p class="submit"><input type="submit" name="commit" value="Rollover the Break Time";> </p>
        </a> 	
	<?php endif; ?>
      </div>
  ...
  <script>
	function cantRollover() {
   	alert("You can't rollover your last break!");
	}
  </script>
