...
<body>
  <div id="wrapper">
    ...
    <section id="sidebar">
      ...
      <div id="resume">        
        <a href="#">
          <p class="submit"><input type="submit" name="commit" value="Resume";> </p>
       </a> 
      </div>
      <div id="pause">        
        <a href="#">
          <p class="submit"><input type="submit" name="commit" value="Pause"></p>
       </a> 
      </div>
       <div id="end">        
...
CountDown.getTimes();
CountDown.Start(breaktimeB * 600);</script>
