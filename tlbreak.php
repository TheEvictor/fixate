...
$sql2 = mysql_query("UPDATE user set breakRange = breakRangeRoll WHERE user_name='$username'");
...
<script type="text/javascript">
			...
			function announcement()
			{
				if(announceTime == 0){
					...
					document.getElementById("timer").innerHTML="<span id=\"countdown\"><a href=\"timer.php\"><p class=\"submit\"><input type=\"submit\" name=\"commit\" value=\"Start Work\";></p></a></span>";
				}	
			}
