...
if (isset($_POST['submit'])) {
    ...
    $sql = mysql_query("UPDATE user set password='$password' where user_name='$username'") or die (mysql_error());
}
?>
<html>
  <head>
  ...
  <div id="wrapper">
    ...
    <section id="sidebar">
      ...
      <section id="intro">
        ...
        <form action="settings.php" name="changepwd" id="changepwd" method="post" accept-charset="UTF-8">
        <fieldset >
        <label for='password' >New Password:</label>
        <input type='password' name='password' id='password' maxlength="50" />
        <br>
        <input type='submit' name='submit' id='submit' value='Submit' onclick="changepwdalert()" />
