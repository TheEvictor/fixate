    ...
    <section id="sidebar">
      ...
      <section id="intro">
        ...
        <header>
          ...
          <p>You have finished all your study sessions! Would you like to: </p>
        </br>
      </header>
      ...
      <div id="break">        
        <a href="homepage.php">
          <p class="submit"><input type="submit" name="commit" value="Go back to homepage";> </p>
       </a> 
      </div>
      <div id="continue">        
        <a href="graphs.php">
          <p class="submit"><input type="submit" name="commit" value="Look at Current Work Analytics";> </p>
       </a> 
      </div>
